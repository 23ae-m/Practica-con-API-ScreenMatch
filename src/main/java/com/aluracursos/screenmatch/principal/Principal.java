...
public class Principal {
    ...
    private final String API_KEY = "&apikey=a81286a3";
    ...
    public void muestraElMenu(){
        ...
        //Transformar los datos a una única lista
        ...
        /*episodios.stream()
                .filter(e -> e.getFechaDeLanzamiento() != null && fechaDeBusqueda.isAfter(fechaDeBusqueda))
